...
const OrdersConfirmed = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://127.0.0.1:8000/api/orders_confirmed/')
    ...
    <AdminLayout>
      <div>
        <h3 className="text-center text-primary mb-4">
          <i className=" fas fa-list-alt me-1"></i>Details of Orders Confirmed
        </h3>
        <h5 className="text-end text-muted">
          {' '}
          <i className="fas fa-database me-1"></i>Total Confirmed Orders{' '}
